...
/**
  | -------------------------------------------------------------------------
  | Customisable File Upload Library for in house projects
  | -------------------------------------------------------------------------
  | This library lets you Upload Files
 * 
 * @package     identimark
...
class Upload {
	 ...
	 * @param array $mimes
	 */
	public function set_allowed_image_types($mimes) {
	...
	protected function create_new_filename() {
		...
		$this->set_filename($filename.".".strtolower(pathinfo($this->file_post["name"], PATHINFO_EXTENSION)));
