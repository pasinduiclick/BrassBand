                                    ...
                                    <form class="cmxform" id="commentForm" method="post" enctype="multipart/form-data" action="../../Services/ProdutsService.php">
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <select name="category" id="accounts" style="width:100%" class="form-control select2" required="required">
                                                    <option disabled="" selected="">Select Category</option>
                                                    <?php
                                                    $query = "SELECT * from product_categories where status=1";
                                                    $result = $databaseConnection->openConnection()->query($query);
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo '<option value="' . $row['prod_cat'] . '" >' . $row['cat_desc'] . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/cookie.png"/>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/note.png"/>
                                                <input type="number" class="form-control" id="icon_input" name="holes" placeholder="Holes">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/note.png"/>
                                                <input type="file" name="cdrfile" class="form-control" id="icon_input" placeholder="CDR File">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/note.png"/>
                                                <input type="file" name="files" class="form-control" id="icon_input" placeholder="Files">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <select name="main_supplier" id="main_supplier" style="width:100%" class="form-control select2">
                                                    <option disabled="" selected="">Select Supplier</option>
                                                    <?php
                                                    $query = "SELECT * from supplier_users where status=1";
                                                    $result = $databaseConnection->openConnection()->query($query);
                                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/note.png"/>
                                               <input type="number" class="form-control" id="icon_input" name="xmm" placeholder="Measurement X mm">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12 icon_input_container">
                                                <img class="icon_input_img" src="../Common/assets/modal-x/img/note.png"/>
                                                <input type="number" class="form-control" id="icon_input" name="ymm" placeholder="Measurement Y mm">
                                            </div>
                                        </div>
