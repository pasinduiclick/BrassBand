...
<div class="content-wrapper">
    ...
    <div class="card" >
        <div class="card-body" >
            <h4 class="card-title">Operation Module Users</h4>
            <div style="display: initial;" data-placement="right" title="Add Operation Module User" data-toggle="tooltip"><button data-toggle="modal" data-target="#exampleModal" type="button"  class="btn btn-inverse-primary btn-fw"><i  class="fa fa-plus"></i></button></div> 

            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-center" style="width: 100%;">Add Operation Module User</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form class="cmxform" id="commentForm" method="post" action="../../Services/OperationLogin.php">
                            <div class="modal-body">
                                ...
                                <fieldset>
                                    ...
                                    <input type="hidden" name="serviceFlag" value="OPREG" />
                                    <?php echo $clib->get_csrf_token(); ?>

                                </fieldset>
                                <div class="badge badge-primary"><li class="fa fa-info-circle" ></li> An Auto Generated Email confirmation will be sent to the Operation Module User</div>
                            </div>
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $query2 = "SELECT * from operation_users where status!=0";
