...
<div class="content-wrapper">
    ...
    <div class="card" >
        <div class="card-body" >
            <h4 class="card-title">Supplier Users</h4>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="cmxform" id="commentForm" method="post" action="../../Services/SupLogin.php">
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label for="email">Module User</label>
                                                <input id="email" class="form-control" value="1" name="module_user" type="checkbox">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <input type="hidden" name="serviceFlag" value="SUPPLIERREG" />
                                    <?php echo $clib->get_csrf_token(); ?>

                                </fieldset>
                                <div class="badge badge-primary"><li class="fa fa-info-circle" ></li> An Auto Generated Email confirmation will be sent to the Supplier User</div>
                            </div>
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $query2 = "SELECT * from supplier_users where status!=0";
