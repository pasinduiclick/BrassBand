...
<script>
    $(document).ready(function () {
        ...
        $('#mem_id').change(function () {
            ...
            var newUrl = "UNI_Issue_History.php?mem_id=" + mem_id;
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="table-responsive hiddenoverflow">
                        <form method="POST" action="Confirm_Issue_UNI.php">

                            <div class="col-md-8 py-5 px-sm-5 ">
                                <span class="inner-modal-title" style="text-align:left !important">Issue Uniforms</span>
                                <div class="form-row">
